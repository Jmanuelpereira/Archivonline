<div class="inicio" style="width:auto; margin-left:0px; margin-top:0px; font-size:12px; float:left">
 ...
 <?php $caso = isset($_GET['caso']) ? $_GET['caso'] : NULL ;
   ...
   case "Rmtlf": { ?>
	   ...
	   case"Rmcorreo": {?>
        <tr valign="baseline">
         <td><span style="margin:0px; float:left;" class="imgboton"><img src="img/iconos/contactop.png" width="16" height="18" /></span><input style="margin:0px;font-size:12px; padding:10px; border-radius:3px; float:left; border-top-left-radius: 0px; border-bottom-left-radius: 0px " name="Correo" id="Correo" type="text" class="campo" placeholder="Correo electronico" size="50" /></td>
       </tr>
       ...
       <tr style="margin-top:10px" valign="baseline">
         ...
         <td style="padding-top:10px" align="right"><input type="submit" class="btn" value="Recuperar contraseña" /></td>
       </tr>
       <?php } endswitch; ?>
     </table>
