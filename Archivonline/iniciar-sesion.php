...
<?php
 ...
 <div class="advertencia" style="margin-right: 10px;" >
  ...
  <h3 style="float:left;">Bienvenido a archivonline</h3>
  <p style="float:left; font-size:12px">Inicia sesion para disfrutar de las ventajas al compartir y descargar archivos.</p>
...
<div style="margin: 1em 25%; width: 350px;"><span style="margin:0px; float:left;" class="imgboton"><img src="img/iconos/contactop.png" width="16" height="18" /></span><input name="usuario" style="font-size:12px; padding:10px;margin:0px; float:left; border-radius:3px; border-top-left-radius: 0px; border-bottom-left-radius: 0px; width:285px" type="text" class="campo"  placeholder="Correo electrónico" /><br /><br />
<br />

  <span style="  float:left; padding:10px; padding-top:9px" class="imgboton"><img src="img/iconos/contra.png" width="14" height="16" /></span><input class="campo"  style="font-size:12px; padding:10px;margin:0px; float:left; border-radius:3px; border-top-left-radius: 0px; border-bottom-left-radius: 0px; width:285px" " placeholder="Contrase&ntilde;a" type="password" name="contrasena" /></div><br /><br /><br />
