...
if (isset($_POST['usuario'])) {
  ...
  if ($action == "IngresarSinMd5") echo $password= ($_POST['contrasena']); else $password= ($_POST['contrasena']) ; 
  $MM_fldUserAuthorization = "Rango";
  $MM_redirectLoginSuccess = "ao/indexad.php";
  $MM_redirectLoginFailed = "restaurar-contrasena.php?r=2";
...
$_GET ['m'] = '1';
   ...
   if ($_GET['m'] == $error) { ?><?php } else { ?><div style="float:right; padding-top:10px">
 <form action="<?php echo $loginFormAction; ?>" name="acceso" id="acceso" METHOD="POST">
   <input name="usuario" class="campo" style="font-size:12px; padding:4px; border-radius:3px" type="text"  id="usuario" placeholder="Correo electrónico" size="22" />
   <input type="password" style="font-size:12px; padding:4px; border-radius:3px" class="campo" placeholder="Contrase&ntilde;a" size="22"  id="contrasena" name="contrasena" />
   <input type="submit" class="boton"  style="padding:4px"  value="Iniciar sesión" class="" />
 </form>
 <div align="right" style="font-size:12px; margin-top:5px; color:#fff"><a style="text-decoration:none; color:#fff" href="index.php" title="Registrarse" target="_blank">Registrarse</a> | <a style="text-decoration:none; color:#fff" href="recuperar.php?m=1" title="Restaurar contraseña " target="_parent">¿Contraseña olvidada?</a></div>
 </div><?php } ?>
</div></div>
<!-- InstanceEndEditable -->
<div class="container"><!-- InstanceBeginEditable name="Contenido" -->
  ...
  <center><div class="sesion" style="height:auto; margin-top:50px; margin-bottom:80px">
  <?php
$notifi = isset($_GET['r']) ? $_GET['r'] : NULL ;
   ...
   case 1: { ?><div class="exito"><img style="float:left" src="img/agregados/1410926033_678134-sign-check-256.png" width="60" height="60" />
    <h2 style="float:left">Tu registro se ha logrado con exito</h2>
  <p style="float:left">Bienvenido a la comunidad, inicia sesion con tus datos y disfruta.</p></div>
<?php
    ...
    case 2: { ?><div class="error" >
  <img style="float:left" src="img/agregados/1410818054_678069-sign-error-256.png" width="60" height="60" />
  <h3 style="float:left;">Acceso negado por combinación erronea</h3>
  <p style="float:left; font-size:12px">Has introducido de manera incorrecta tus datos de usuario. </p></div>

  
  <?php } break; 
  default: {
  ?>
 <div class="advertencia" style="margin-right: 10px;" >
  <img style="float:left" src="img/agregados/1420496536_19-256.png" width="60" height="60" />
  <h3 style="float:left;">Restaurar contraseña</h3>
  <p style="float:left; font-size:12px">Inicia sesión con los datos enviados a tu correo, utiliza la contraseña provicional.</p>
...
<span style="margin:0px; float:left; margin-left:150px" class="imgboton"><img src="img/iconos/contactop.png" width="16" height="18" /></span><input name="usuario" style="font-size:12px; padding:10px;margin:0px; float:left; border-radius:3px; border-top-left-radius: 0px; border-bottom-left-radius: 0px" type="text" class="campo" size="50" placeholder="Correo electrónico" /><br /><br />
<br />

  <span style=" margin-left:150px;  float:left; padding:10px; padding-top:9px" class="imgboton"><img src="img/iconos/contra.png" width="16" height="16" /></span><input class="campo"  style="font-size:12px; padding:10px;margin:0px; float:left; border-radius:3px; border-top-left-radius: 0px; border-bottom-left-radius: 0px" size="50" placeholder="Contrase&ntilde;a" type="password" name="contrasena" /><br /><br /><br />
