...
<div class="container"><!-- InstanceBeginEditable name="Contenido" -->
  <div class="content" style="height:480px; width:1200px">
...
$_GET ['r'] = '1';
  ...
  <div class="sesion" style="width:850px; height:200px; margin-left:150px; margin-top:20px; font-size:12px">
    <div style="float:left"><img src="img/iconos/1413098475_699328-icon-56-document-text-128.png" width="128" height="128" />
  ...
  <tr>
    ...
    <div class="advertencia" style="float:left; margin-left:50px; width:200px">
