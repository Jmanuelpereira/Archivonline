...
<form action="<?php echo $editFormAction; ?>" method="post" style="float:right; margin:20px" name="form1" id="form1">
  <h3 style="padding-left:5px; margin-bottom:0px">Abre una cuenta</h3>
    <p style="padding-left:5px; margin-bottom:10px; font-size:10px">Es totalmente gratis</p>
      <table align="center">
        <tr valign="baseline">
          
          <td><span id="sprytextfield1">
            <input type="text" class="campoindex" style="margin:0px;font-size:12px; padding:10.5px;   width:85% " name="Nombre" value="" placeholder="Nombre" size="32" />
        ...
        <tr valign="baseline">
          ...
          <span id="sprytextfield2">
            <input name="Apellido" type="text" style="margin:0px;font-size:12px; padding:10.5px;   width:85%" class="campoindex" value="" placeholder="Apellido" size="32" />
          <span class="textfieldValidState"></span></span>
          </td>
        </tr>
        ...
        <tr valign="baseline">
          ...
          <input name="Correo" id="usuario" type="text" class="campoindex" value="" style="margin:0px;font-size:12px; padding:10.5px;   width:85% " placeholder="E-mail" size="32" />
          <span class="textfieldValidState"></span><span class="textfieldValidState"></span></span></td>
        </tr>
        <tr valign="baseline">
          
          <td><span id="sprytextfield4">
            <input name="Telefono" id="Telefono" type="text" class="campoindex" style="margin:0px;font-size:12px; padding:10.5px;   width:85% " value="" placeholder="Teléfono movil" size="32" />
          <span class="textfieldValidState"></span><span class="textfieldValidState"></span></span></td>
        </tr>
        <tr valign="baseline">
          
          <td><span id="sprytextfield5">
            <input name="Contrasena" type="password" class="campoindex" value="" style="margin:0px;font-size:12px; padding:10.5px;   width:85% " placeholder="Contrase&ntilde;a" size="32" />
          <span class="textfieldValidState">.</span></span></td>
        </tr>
        <tr valign="baseline">
          
          <td><span id="spryselect1">
            <select style="margin:0px;font-size:12px; padding:10.5px;   width:95% "  class="campoindex" name="select">
              <option value="0" class="campoindex">Universidad</option>
        ...
        <tr valign="baseline">
          ...
          <label style="font-size:auto; float:left">
            <input type="radio" name="Sexo" value="1" id="Sexo_0" />
            Hombre</label>
          
          <label style="font-size: auto; float:left; margin-left:30px">
...
Al registrarse aceptas nuestros terminos y condiciones de usuarios.</td>
        </tr>
        <tr valign="baseline">
          
          <td align="center"><input type="submit" style="padding:10px; font-size:auto; width:100%;    box-shadow: 0 0 10px #53A9FF;
...
var sprytextfield4 = new Spry.Widget.ValidationTextField("sprytextfield4", "custom", {validateOn:["blur"], pattern:"0000-0000000", useCharacterMasking:true});
