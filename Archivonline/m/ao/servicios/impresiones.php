...
<p style="font-size:12px">Introduce el numero de documento que desees imprimir y verifica los datos.</p></div><form action="impresiones.php">
...
if ($_GET['Documento'])  { ?>
<h3 style="margin-bottom:0px; float:left; padding-top:10px"><img src="../../img/iconos/imprimir.png" width="15" height="15" /> Imprimir documento #<?php echo $row_Recordset1['Contador']; ?></h3> 
...
<table style="text-align:left;  margin-left:10px; margin-bottom:10px" width="auto" border="0" cellspacing="2" cellpadding="2">
   <tr>
    ...
    <td class="td"><strong>Pagina carta B/N:</strong> 5,00 bsf o 1,00 Crd</td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td class="td"><strong>Pagina oficio B/N: </strong> 6,00 bsf o 1,50 Crd</td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td class="td"><strong>Carpeta marrón + Gancho:</strong> 25,00 bsf o 10,00 Crd</td>
  </tr>
  
  <tr>
    
    <td class="td"><strong>Carpeta manila</strong> 15,00 bsf o 6,00 Crd</td>
  </tr>
...
Al costo final se le recargara <strong style="color:#F00">5 Bsf</strong>  referentes a los costos de envió y entrega  del mismo.
<br />
<br />
Si el trabajo que solicitas es de <strong style="color:#F00">URGENCIA</strong>(Para el mismo dia en que se solicite)se recargara un costo de <strong style="color:#F00">10,00 Bsf</strong> al monto final.
<br />
</div></div>
...
<p style="font-size:12px; color:#F00">ANTES DE REALIZAR CUALQUIER COMPRA ES NECESARIO COMPLETAR TU PERFIL DE USUARIO.<br />
...
<a href="impresiones.php?i=1" style="float:right; width:120px" class="opcionesperfil">Solicitar impresión</a>
    <?php } ?>
  </div>
  ...
  <?php 
   ...
   <div class="datosperfil"><table style="text-align:left; float:left; font-size:12px" width="auto" border="0" cellspacing="2" cellpadding="2">
   <tr>
