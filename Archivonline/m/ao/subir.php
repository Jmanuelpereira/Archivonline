...
<?php if ((isset($_POST["enviado"])) && ($_POST["enviado"] == "form1")) {
	...
	move_uploaded_file($_FILES['userfile']['tmp_name'], "archivos/".$nombre_archivo);
...
<div class="gestionimagen"><form action="subir.php" method="post" style="padding-top:10px" enctype="multipart/form-data" id="form1" name="form1" class="margensuperior">

  <p>
    <input class="Botontablas" style="width:auto" name="userfile" type="file" multiple="true" />
  </p>
  <p>
   <p align="right"><a style="color:#FFF; text-decoration:none; margin-bottom:0" class="Botontablas" href="javascript:document.form1.submit();"><span>Subir</span></a></p> 
