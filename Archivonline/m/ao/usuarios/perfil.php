...
$(document).ready(function(){
   $("#universidad").change(function () {
           $("#universidad option:selected").each(function () {
            elegido=$(this).val();
            $.post("<?php if 
	
	($_GET['d'] == 3) { 
	
	?>require/<?php } else {?>../require/<?php } ?>sedes.php", { elegido: elegido }, function(data){
            $("#sede").html(data);
            });            
        });
   })
     ...
     <form action="<?php echo $editFormAction; ?>" method="POST" name="form1" id="form1">
       ...
       <!--  <tr valign="baseline">
         ...
         <tr valign="baseline">
           ...
           <td class="tdnohover"><select id="universidad" name="Universidad">
         ...
         <tr valign="baseline">
           ...
           <td class="tdnohover"><select id="sede" name="Sede">
