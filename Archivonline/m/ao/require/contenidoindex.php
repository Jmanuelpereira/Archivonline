...
<img src="../img/iconos/1409342503_error.png" width="10" height="10" /> En un mes estara disponible la nueva versión de la pagina, fecha estimada <strong>15/02/15</strong>.
  ...
  <div class="menuizquierdo" style="width:auto"><div style="float:left; margin-right:5px"><img style="border-radius:3px; box-shadow: 0 0 10px #ccc;
    -webkit-box-shadow: 0 0 10px #ccc;
    -moz-box-shadow: 0 0 10px #ccc;" src="usuarios/imgp/<?php if ($_SESSION['MM_Imagen'])  
