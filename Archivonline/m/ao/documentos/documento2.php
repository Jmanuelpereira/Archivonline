...
<a style="color:#000; text-decoration:none" id="fancybox-close" href=""><div class="opcionesperfil" style="width:120px"><img style="margin-right:3px" src="../img/iconos/1418289002_arrow-back-128.png" width="12" height="12" /> Volver</div> </a>
  <a style="color:#000; text-decoration:none" href="document.location='archivos/<?php echo $row_DetailRS1['Nombreachivo']; ?>'"> <div class="opcionesperfil" style="width:120px"><img style="margin-right:3px" src="../img/iconos/1420593747_download.png" width="12" height="12" /> Descargar</div> </a>
   <a  style="color:#000; text-decoration:none" onclick="alert('Copiado al portapapeles');" width="12" height="12" /><div class="opcionesperfil" style="width:120px"><img style="margin-right:3px" src="../img/iconos/compartir.png" width="10" height="10" /> Compartir</div></a> 
  
   <?php if ($row_DetailRS1['Uplauder'] == $_SESSION['MM_Username']){ ?>
  
  <a style="color:#000; text-decoration:none" href="documentos/documento-eliminar.php?recordID=<?php echo $_GET['Documento'] ?>"> <div class="opcionesperfil" style="width:120px"><img style="margin-right:3px" src="../img/iconos/1420593516_RecycleBin.png" width="10" height="10" /> Borrar documento</div></a><br />


<?php } else { ?>

<a style="color:#000; text-decoration:none" href="../acciones/denunciar.php?documento=<?php echo $_GET['Documento'] ?>"><div class="opcionesperfil" style="width:120px"><img style="margin-right:3px" src="../img/iconos/1420594514_519900-165_ExclamationMark-128.png" width="10" height="10" /> Denunciar</div></a><?php }?>
