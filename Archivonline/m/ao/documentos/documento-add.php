...
<form action="<?php echo $editFormAction; ?>" method="POST" style="float:left; margin:10px" name="form1" id="form1">
    <h2 style="padding:0px"><img src="../../img/agregados/1411615358_678092-sign-add-128.png" width="14" height="14" /> Agregar archivo </h2>
    <br />
      ...
      <table align="center" style="font-size:12px">
        <tr valign="baseline">
          ...
          <td class="tdnohover"><span id="sprytextfield1">
            <input name="Nombre" type="text" style='padding:5px; padding-right:20px' value="" placeholder="Nombre del archivo" class=""  maxlength="25" />
        ...
        <tr valign="baseline">
          ...
          <input style="width:auto; font-size:12px; height:25px; padding:3px; margin-top:0px"  name="button2" type="button" class="opcionesperfil" id="button2" onClick="javascript:subirimagen('Nombreachivo');" value="Seleccionar"/></td>
        </tr>
