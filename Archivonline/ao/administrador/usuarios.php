...
mysql_select_db($database_archivo, $archivo);
$query_Recordset1 = "SELECT * FROM usuarios  ORDER BY usuarios.Contador DESC";
$query_limit_Recordset1 = sprintf("%s LIMIT %d, %d", $query_Recordset1, $startRow_Recordset1, $maxRows_Recordset1);
$Recordset1 = mysql_query($query_limit_Recordset1, $archivo) or die(mysql_error());
$row_Recordset1 = mysql_fetch_assoc($Recordset1);
...
<!--  <form style="margin-bottom:20px" action="usuarios.php">
<input type="search" id="id" name="id" style="float:right; transition: none; width: 250px;	color: #000;
	background-color: #FFF;" placeholder="ID de usuario" size="30" /></form>-->
 

  <table class="table-fill" style="width:1000px; margin-top:10px; float:left"  border="1" align="center">
    <tr>
     <thead>
      <th>ID </th>
      <th>Persona</th>
    ...
    <?php do { ?>
      <tr>
        <td class="text-left"> <?php echo $row_Recordset1['Contador']; ?></td>
        <td class="text-left"><?php echo $row_Recordset1['Nombre']; ?> <?php echo $row_Recordset1['Apellido']; ?></td>
        
        <td class="text-left"><?php echo $row_Recordset1['Correo']; ?>&nbsp; </td>
        <td class="text-left"><?php 
		if ($row_Recordset1['Rango'] == 1) echo "EST";
		if ($row_Recordset1['Rango'] == 5) echo "ADM";
		if ($row_Recordset1['Rango'] == 2) echo "PRF"; ?>&nbsp; </td>
        <td class="text-left"><?php echo $row_Recordset1['Fecharegistro']; ?>&nbsp; </td>
        <td><?php if ($row_Recordset1['Estado'] == 1) echo "Activo"; ?>&nbsp; </td>
        <td class="text-left"><a href="usuario-ver.php?recordID=<?php echo $row_Recordset1['Contador']; ?>" class="opcionesperfil">Ver usuario</a> </td>
      </tr>
...
Registros <?php echo ($startRow_Recordset1 + 1) ?> a <?php echo min($startRow_Recordset1 + $maxRows_Recordset1, $totalRows_Recordset1) ?> de <?php echo $totalRows_Recordset1 ?>-->
    ...
    <div class="inicio" style="float:left; height:auto; background-color:transparent; border: #FFF; width:950px; margin-top:0px">
