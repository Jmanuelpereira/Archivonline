...
$_GET ['r'] = '1';
  ...
  { ?>
	...
	?>../<?php } else {?>../../<?php } ?>img/agregados/1411615358_678092-sign-add-128.png" width="28" height="28" /> Agregar documento </h1>
      <table align="center">
        <tr valign="baseline">
       ...
       <!-- <tr valign="baseline">
        ...
        <tr valign="baseline">
          ...
          <td class="tdnohover" height="26">
           <select style="float:left; padding:3px; padding-left:15px" name="Carrera" id="Carrera" >
            ...
            <select style="float:left; padding:3px; padding-left:15px" name="Semestre" id="semestre" >
           ...
           <select  style="float:left; padding:3px; padding-left:15px" name="Materia" id="materia">
