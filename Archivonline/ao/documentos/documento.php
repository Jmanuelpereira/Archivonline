...
<img src="../../img/iconos/1409342503_error.png" width="10" height="10" /> Cualquier problema o error escribenos al correo electronico <strong>contacto@archivonline.com.ve</strong>.
  ...
  <div class="inicio" style="float:left; width:auto; height:auto; font-size:12px">
    <div style="width:150px; float:left; margin-left:10px"><img style="border-radius:3px" src="../../img/iconos/documento-pdf.png" width="130" height="120" /><br />
...
<div class="opcionesperfil" style="width:120px"><a style="color:#000; text-decoration:none" href="javascript:history.back()"><img style="margin-right:3px" src="../../img/iconos/1418289002_arrow-back-128.png" width="12" height="12" /> Volver</a></div> 
   <div class="opcionesperfil" style="width:120px"><a style="color:#000; text-decoration:none" href="../archivos/<?php echo $row_DetailRS1['Nombreachivo']; ?>"><img style="margin-right:3px" src="../../img/iconos/1420593747_download.png" width="12" height="12" /> Descargar</a></div> 
   ...
   <div class="opcionesperfil" style="width:120px"><a style="color:#000; text-decoration:none" href="documento-eliminar.php?recordID=<?php echo $_GET['Documento'] ?>"><img style="margin-right:3px" src="../../img/iconos/1420593516_RecycleBin.png" width="10" height="10" /> Borrar documento</a></div><br />
...
<div class="completar" style="width:auto; padding:5px; margin-left:0px; margin-top:10px; cursor:auto"><p style="color:#CC3333; font-size:11px; padding:0px">Todos los documentos disponibles en archivonline son totalmente gratuitos, si algun usuario te cobra por su uso reportalo.</p>
