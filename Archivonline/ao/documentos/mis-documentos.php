...
$query_Recordset1 = sprintf("SELECT * FROM documentos WHERE documentos.Uplauder = %s ORDER BY documentos.Contador DESC", GetSQLValueString($varUsuario_Recordset1, "text"));
...
<!-- InstanceEndEditable -->
  ...
  <div class="content">
    ...
    </div></a><?php } while ($row_Recordset1 = mysql_fetch_assoc($Recordset1)); }   else { ?><div style="width:auto; alignment-adjust:central; padding-top:20px; color:#CC3333" class="advertencia"><h1>No tienes documentos</h1></div><?php } ?>
