...
--
-- Servidor: localhost
-- Tiempo de generación: 21-08-2014 a las 16:06:30
...
--
-- Estructura de tabla para la tabla `tblpresupuesto`
--
...
CREATE TABLE IF NOT EXISTS `tblpresupuesto` (
  ...
  `intTipo` int(11) NOT NULL,
  `intMetodopago` int(11) NOT NULL,
  `intNegocio` int(11) NOT NULL,
  `intTiempo` int(11) NOT NULL,
  `strCorreo` varchar(100) NOT NULL,
  `strComentario` varchar(500) NOT NULL,
  PRIMARY KEY (`intContador`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=4 ;

--
-- Volcado de datos para la tabla `tblpresupuesto`
--

INSERT INTO `tblpresupuesto` (`intContador`, `strNombre`, `strApellido`, `strCedula`, `intPlan`, `intTipo`, `intMetodopago`, `intNegocio`, `intTiempo`, `strCorreo`, `strComentario`) VALUES
(1, 'Jose', 'Pereira', '', 4, 2, 2, 0, 1, 'Jmanuelpereira2@gmail.com', 'Espero sus servicios valgan la pena.'),
(2, 'Manuel', 'Griman', '', 2, 2, 3, 0, 3, 'Jmanuelpereira2@gmail.com', 'Hola a todos'),
(3, 'Jose', 'Pereira', 'V-25531917', 1, 1, 2, 0, 3, 'Jmanuelpereira2@gmail.com', 'Espare mi pedido con gusto, muy buena pagina.');
